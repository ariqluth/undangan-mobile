...
class AuthProvider with ChangeNotifier {
  ...
  Future<void> login(String email, String password) async {
    ...
    final url = Uri.parse('https://98b6-180-248-22-3.ngrok-free.app/api/auth/login');
  ...
  Future<void> register(String name, String email, String password, String role, String device) async {
    ...
    final url = Uri.parse('https://98b6-180-248-22-3.ngrok-free.app/api/auth/register');
    final response = await http.post(
      url,
      body: {
        'name': name,
  ...
  Future<void> logout() async {
    ...
    final url = Uri.parse('https://98b6-180-248-22-3.ngrok-free.app/api/auth/logout');
    final response = await http.post(
      url,
      headers: {
